...
public class AppMenu2 extends JFrame {
    ...
    // 1. Création du filtre (Description, puis extensions)
    FileNameExtensionFilter filtre = new FileNameExtensionFilter("Fichiers texte (.txt)", "txt");
    
    // 2. Application du filtre au sélecteur
    jfc.setFileFilter(filtre);
    
    // 3. Optionnel : Désactiver l'option "Tous les fichiers"
    ...
    switch(retour) {
        case JFileChooser.APPROVE_OPTION:
            actionLabel.setText("Statut : Fichier chargé");
            fichierLabel.setText("Nom : " + jfc.getSelectedFile().getName());
            break;
        case JFileChooser.CANCEL_OPTION:
            actionLabel.setText("Statut : Annulé");
            break;
    }
}
